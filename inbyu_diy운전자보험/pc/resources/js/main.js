$(function() {
    ...
    $window.on('load scroll', throttle(function(){
        ...
        $html.toggleClass('is-scroll-downed', (scrollTop >= 90));
    ...
    setTimeout(function(){
        ...
        var $bottomFull = $('.is-bottom-full');
        if ( $bottomFull.length ) {
            console.log($window.height());
            $bottomFull.css({ minHeight : $window.height() - $bottomFull.offset().top - 339 });
        }
    }, 10);
});
