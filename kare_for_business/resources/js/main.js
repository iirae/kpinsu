$(function() {
    ...
    var _getFooterHeight = function(_num) {
        var _result = _num;
        var $footer = $('#footer');
        if (_result <= 10 && $footer.length) {
            _result = $footer.outerHeight();
        }
        return _result;
    };
    ...
    var stickyPageUp = function(){ // pageUp sticky 기능 적용
        ...
        var _core = function(e){
            ...
            _footerHeight = _getFooterHeight(_footerHeight);
            ...
            if (_bool === true) {
                ...
                // console.log('_________________top', _top, $('#pageUp'));
            } else {
    ...
    if ( !$('.section-main').length || $html.hasClass('ie') && $('.section-main').length) {
        stickyPageUp();
    }
