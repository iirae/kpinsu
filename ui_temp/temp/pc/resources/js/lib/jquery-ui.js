...
$.extend( Datepicker.prototype, {
	...
	_showDatepicker: function( input ) {
		...
		$('body').addClass('overlay'); // dh
		$('body').append('<div class="datepicker-dimmed"></div>'); // dh
		inst.dpDiv.addClass('show'); // dh
	...
	_hideDatepicker: function( input ) {
		...
		if ( this._datepickerShowing ) {
			...
			if ( $.effects && ( $.effects.effect[ showAnim ] || $.effects[ showAnim ] ) ) {
				...
				$('body').removeClass('overlay'); // dh
				$('.datepicker-dimmed').remove(); //dh
				inst.dpDiv.removeClass('show'); // dh
			}
